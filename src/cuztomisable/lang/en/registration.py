translations = {
    ...
    "success_and_logged_in": "Your account has been created and you are now logged in!",
    "success_verification_required": "Your account has been created, but you must verify your {type} before you can log in.",
    "verification_success": "Verified successfully. You can now log in.",
    "errors": {
